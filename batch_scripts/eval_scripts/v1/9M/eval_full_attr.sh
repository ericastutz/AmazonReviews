...
python eval_full_attr.py \
   ...
   --data_prefix 'val' \
   --out_dir ./out/cat_v1/9M/9M_0.05/full_eval_results \
   --total_seqs 1000000 \
   --batch_size 512 \
   --max_seq_len 512 \
   --summary_only \
...
python eval_full_attr.py \
   ...
   --dl_name 'cat_inference' \
   --data_prefix 'val' \
   --out_dir ./out/cat_v1/9M/9M_0.1/full_eval_results \
   --total_seqs 1000000 \
   --batch_size 512 \
   --max_seq_len 512 \
   --summary_only \
...
python eval_full_attr.py \
   ...
   --dl_name 'cat_inference' \
   --data_prefix 'val' \
   --out_dir ./out/cat_v1/9M/9M_0.15/full_eval_results \
   --total_seqs 1000000 \
   --batch_size 512 \
   --max_seq_len 512 \
   --summary_only \
...
python eval_full_attr.py \
   ...
   --dl_name 'cat_inference' \
   --data_prefix 'val' \
   --out_dir ./out/cat_v1/9M/9M_0.3/full_eval_results \
   --total_seqs 1000000 \
   --batch_size 512 \
   --max_seq_len 512 \
   --summary_only \
...
python eval_full_attr.py \
   ...
   --dl_name 'cat_inference' \
   --data_prefix 'val' \
   --out_dir ./out/cat_v1/9M/9M_0.5/full_eval_results \
   --total_seqs 1000000 \
   --batch_size 512 \
   --max_seq_len 512 \
   --summary_only \
...
python eval_full_attr.py \
   ...
   --dl_name 'cat_inference' \
   --data_prefix 'val' \
   --out_dir ./out/cat_v1/9M/9M_0.8/full_eval_results \
   --total_seqs 1000000 \
   --batch_size 512 \
   --max_seq_len 512 \
   --summary_only \
...
python eval_full_attr.py \
   ...
   --dl_name 'cat_inference' \
   --data_prefix 'val' \
   --out_dir ./out/cat_v1/9M/9M_1.0/full_eval_results \
   --total_seqs 1000000 \
   --batch_size 512 \
   --max_seq_len 512 \
   --summary_only \
